...
export class NgSwipeablePanelExternalService {
	...
	public hidePanels(hide: boolean): void {
		this.panelRefs.forEach((ref) => ref.componentRef.instance.setHidePanel(hide));
	}
	...
	private addPanelSettings(
		...
		for (const [key, value] of Object.entries(settings)) {
			componentRef.instance[key as keyof PanelSettings] = value as boolean & HTMLElement;
		}
